...
<head>
  ...
  <title>Login | Laundry App PPKDJP Angkatan 2</title>
...
<body>
  <div class="login-card">
    <div class="text-center py-4">
      <img src="http://yourdomain.com/path-to-image/logo.svg" alt="" class="mb-3" style="max-width: 120px;">
      <h3 class="fw-semibold text-primary">Login Laundry</h3>
